        ...
        if(response) {
            ...
            $.each(response, function(index, order) {
                ...
                table += '<tr>' +
                    ...
                    '<td>'+
                    '<span class="btn btn-xs btn-primary view-order" data-id="'+ order.order_id +'">View</span> '+
...
// Print/PDF receipt: opens a standalone receipt page in a new tab for this order.
